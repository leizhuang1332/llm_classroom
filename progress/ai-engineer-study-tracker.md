...
| B. 大模型开发工具与框架 | 17% | 4 | 6 | 67% | 进行中 |
| C. 提示工程与上下文设计 | 14% | 0 | 6 | 0% | 未开始 |
| D. 大模型应用架构设计 | 18% | 1 | 6 | 17% | 进行中 |
...
#### B.8 微调方法选择依据 - 2025-12-20 (高信心)
- **掌握内容**:
  - 基于资源限制的微调方法选择：GPU内存、计算时间等因素
  - 基于任务特点的微调方法选择：单一任务vs多任务、领域适配等
  - 微调方法对比分析：LoRA、QLoRA、P-tuning、PPO的优缺点
  - 实际案例应用：教育科技AI助手、医疗问答系统等场景
  - 简化决策框架：资源优先级→任务特点→部署需求→数据可用性
- **关键理解**:
  - 微调方法选择应基于资源限制和任务特点进行综合评估
  - LoRA适合单一任务，P-tuning适合多任务切换，QLoRA适合资源受限场景
  - 简化决策框架能够快速指导实际应用中的微调方法选择
- **参考资料**:
  - 会话笔记: `/sessions/2025-12-20/session-notes.md`
  - 实战案例: 教育科技AI助手微调方法选择
  - 理论讲解: 微调方法选择框架和对比分析
...
#### D.19 RAG与微调协作方式 - 2025-12-20 (高信心)
- **掌握内容**:
  - 四种主要协作方式：检索增强微调、领域适配微调+RAG、双模型协作架构、端到端RAG微调
  - 各种协作方式的核心原理、训练数据、优势和限制
  - 协作方式选择框架：基于资源需求、实现难度、性能要求等因素
  - 实际应用案例：医疗问答系统、法律咨询系统、客服机器人等
  - 代码实战案例：四种协作方式的完整实现代码
- **关键理解**:
  - RAG与微调协作能够取长补短，提升系统整体性能
  - 领域适配微调+RAG是专业领域应用的最佳实践方案
  - 协作方式选择应基于具体场景需求和资源限制
- **参考资料**:
  - 会话笔记: `/sessions/2025-12-20/session-notes.md`
  - 实战代码: 四种RAG与微调协作方式的完整实现
  - 理论讲解: 协作方式对比分析和选择框架
